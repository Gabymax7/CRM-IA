...
# --- CONFIGURACIÓN IA: GEMINI 3 FLASH (NOMBRE TÉCNICO CORRECTO) ---
genai.configure(api_key=st.secrets["GEMINI_API_KEY"])
# Usamos el nombre exacto de tu lista de diagnóstico
...
if prompt := st.chat_input("¿Qué novedades hay?"):
    ...
    with st.chat_message("assistant"):
        ...
        instruccion = f"Hoy es {fecha_hoy}. Eres el gestor de MyCar. Responde con brevedad. Si hay datos para guardar usa el formato DATA_START {{...}} DATA_END."
        ...
        try:
            # Gemini 3 Flash Preview (Lanzado 17/12/2025)
            ...
            if "DATA_START" in res_text:
                ...
                if json_data.get("ACCION") == "GUARDAR_AUTO": guardar_o_actualizar_stock(json_data)
